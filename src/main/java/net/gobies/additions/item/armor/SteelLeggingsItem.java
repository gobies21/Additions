...
public class SteelLeggingsItem extends ArmorItem {
    public SteelLeggingsItem(Properties properties) {
        super(ModArmorMaterials.STEEL, Type.LEGGINGS, properties);
    }
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        if (event.getEntity() instanceof Player player) {
            if (event.getSource().is(DamageTypes.LAVA) ||
                ...
                if (player.getItemBySlot(EquipmentSlot.LEGS).getItem() instanceof SteelLeggingsItem) {
