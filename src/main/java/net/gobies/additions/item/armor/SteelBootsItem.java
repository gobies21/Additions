...
public class SteelBootsItem extends ArmorItem {
    public SteelBootsItem(Properties properties) {
        super(ModArmorMaterials.STEEL, Type.BOOTS, properties);
    }
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        if (event.getEntity() instanceof Player player) {
            if (event.getSource().is(DamageTypes.LAVA) ||
                ...
                if (player.getItemBySlot(EquipmentSlot.FEET).getItem() instanceof SteelBootsItem) {
