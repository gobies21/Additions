...
public class AdditionsCreativeTab {
    ...
    public static final RegistryObject<CreativeModeTab> ADDITIONS_TAB;

    static {
        CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, Additions.MOD_ID);
        ADDITIONS_TAB = CREATIVE_MODE_TABS.register("additions_tab",
