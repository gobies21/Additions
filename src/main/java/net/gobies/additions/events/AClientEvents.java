    ...
    */
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        if (currentItemType instanceof TieredItem && (!(currentItemType instanceof DiggerItem)) || currentItemType instanceof TridentItem || AdditionsUtil.isValidWeapon(currentItemType)) {
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.PLAYER_SWORD_EQUIP.get(), SoundSource.PLAYERS, CommonConfig.SOUND_VOLUME.get().floatValue(), 1.0F);
        } else if (currentItemType instanceof BowItem || currentItemType instanceof CrossbowItem) {
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.PLAYER_BOW_EQUIP.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.6F, 1.0F);
            ...
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.PLAYER_TOOL_EQUIP.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.4F, 1.0F);
        } else if (currentItemType instanceof PotionItem) {
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.POTION.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.6F, 1.0F);
        } else if (hasCrystal) {
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.ARMOR_CRYSTAL_WALK.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.6F, 1.0F);
        } else if (hasLight) {
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.ARMOR_LIGHT.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.6F, 1.0F);
        } else if (hasMedium) {
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.ARMOR_MEDIUM.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.6F, 1.0F);
        } else if (hasHeavy) {
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.ARMOR_HEAVY_WALK.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.6F, 1.0F);
        } else if (armor.getItem() instanceof ArmorItem) {
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.ARMOR_HEAVY_WALK.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.6F, 1.0F);
        } else if (!currentItemType.getDefaultInstance().isEmpty()){
            player.level().playSound(null, player.blockPosition(), AdditionsSounds.PLAYER_OTHER_EQUIP.get(), SoundSource.PLAYERS, (CommonConfig.SOUND_VOLUME.get().floatValue() - 1) + 0.6F, 1.0F);
        }
